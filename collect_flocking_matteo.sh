...
for i in {1..3}
do
  python policy.py --wandb_name flocking_close_nocomms --seed $i -c flocking_close --model ippo --no_stand --training_iterations 100 --train_batch_size 2500 --sgd_minibatch_size 1024 --num_envs 4 --no_render_eval_callbacks
  python policy.py --wandb_name flocking_close_sae_frozen --seed $i -c flocking_close --model joippo --encoder sae --encoding_dim 32 --encoder_file weights/sae_flocking.pt --training_iterations 100 --train_batch_size 2500 --sgd_minibatch_size 1024 --num_envs 4 --no_render_eval_callbacks
